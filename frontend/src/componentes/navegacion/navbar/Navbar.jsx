                ...
                <div className="hidden md:flex items-center gap-8">
                    {!estaAutenticado ? (
                        ...
                        <>
                            ...
                            <NavLink href="/">Nuevo Libro</NavLink>
                            <AccionRecomendada href="/" variante="primario">
                                Mi Perfil
                            </AccionRecomendada>
                        </>
            ...
            */}
            ...
            `}>
                <div className="flex flex-col items-center gap-6 px-10">
                    {!estaAutenticado ? (
                        <>
                            <NavLink href="/" esMovil onClick={cerrarMenu}>Iniciar sesión</NavLink>
                            <AccionRecomendada href="/" variante="outline" esMovil onClick={cerrarMenu}>
                                Registrarse
                            </AccionRecomendada>
                        </>
                    ) : (
                        <>
                            <NavLink href="/" esMovil onClick={cerrarMenu}>Feed</NavLink>
                            <NavLink href="/" esMovil onClick={cerrarMenu}>Explorar</NavLink>
                            <NavLink href="/" esMovil onClick={cerrarMenu}>Nuevo Libro</NavLink>
                            <AccionRecomendada href="/" variante="outline" esMovil onClick={cerrarMenu}>
                                Mi Perfil
                            </AccionRecomendada>
                        </>
